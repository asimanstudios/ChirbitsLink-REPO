...
namespace ChibiCocina.Clientes
{
    public class GestorDePedidos : MonoBehaviour
    {
        public static GestorDePedidos Instancia { get; private set; }
        
        [Header("Configuración de Pedidos")]
        public GameObject[] prefabIngredientes;
        public Transform[] puntosEntrega;
        public float tiempoEntrePedidos = 30f;
        public int maximoPedidosActivos = 5;
        
        // Estado de pedidos
        private List<Pedido> pedidosActivos;
        private List<Pedido> pedidosCompletados;
        private float tiempoSiguientePedido;
        private int idPedidoActual;
        
        // Eventos
        public System.Action<Pedido> OnPedidoCreado;
        public System.Action<Pedido> OnPedidoCompletado;
        public System.Action<Pedido> OnPedidoCancelado;
        public System.Action<int> OnPedidosActualizados;
