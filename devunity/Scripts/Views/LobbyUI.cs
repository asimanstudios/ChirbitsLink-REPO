...
namespace ChibitsLink.UI
{
    public class LobbyUI : MonoBehaviour
    {
        ...
        public Button backButton; // Nuevo: Botón para cerrar la sala
        public Button quitButton; // Nuevo: Botón para salir del juego
        public TextMeshProUGUI statusText;
        public TextMeshProUGUI connectedPlayersText; // Nuevo: Para mostrar nombres

        [Header("Network Selection")]
        public TMP_Dropdown ipDropdown; // Asignar en el Inspector
